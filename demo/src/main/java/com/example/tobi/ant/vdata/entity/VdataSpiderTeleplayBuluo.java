...
@TableName("vdata.vdata_spider_teleplay_buluo")
@ApiModel(value = "VdataSpiderTeleplayBuluo对象", description = "")
public class VdataSpiderTeleplayBuluo extends Model<VdataSpiderTeleplayBuluo> {

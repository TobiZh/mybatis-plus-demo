...
@TableName("vdata.vdata_spider_teleplay_sotrend")
@ApiModel(value = "VdataSpiderTeleplaySotrend对象", description = "")
public class VdataSpiderTeleplaySotrend extends Model<VdataSpiderTeleplaySotrend> {
    ...
    @TableField("teleplay_sotrend")
    private Integer teleplay_sotrend;

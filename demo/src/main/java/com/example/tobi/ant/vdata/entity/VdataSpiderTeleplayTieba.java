...
@TableName("vdata.vdata_spider_teleplay_tieba")
@ApiModel(value = "VdataSpiderTeleplayTieba对象", description = "")
public class VdataSpiderTeleplayTieba extends Model<VdataSpiderTeleplayTieba> {

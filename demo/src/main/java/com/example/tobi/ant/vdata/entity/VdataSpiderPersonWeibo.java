...
@TableName("vdata.vdata_spider_person_weibo")
@ApiModel(value = "VdataSpiderPersonWeibo对象", description = "")
public class VdataSpiderPersonWeibo extends Model<VdataSpiderPersonWeibo> {

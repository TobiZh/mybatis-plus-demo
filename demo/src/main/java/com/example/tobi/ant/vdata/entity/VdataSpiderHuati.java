...
@TableName("vdata.vdata_spider_huati")
@ApiModel(value = "VdataSpiderHuati对象", description = "")
public class VdataSpiderHuati extends Model<VdataSpiderHuati> {
    ...
    @TableField("huati")
    private Integer huati;

    @TableField("data_time")
    private LocalDate data_time;

    @TableField("read_count_raw")
    private Long read_count_raw;

    @TableField("read_count_corr")
    private Long read_count_corr;

    @TableField("read_count_incr")
    private Long read_count_incr;

...
@TableName("vdata.vdata_spider_zy_site_qq")
@ApiModel(value = "VdataSpiderZySiteQq对象", description = "")
public class VdataSpiderZySiteQq extends Model<VdataSpiderZySiteQq> {
    ...
    @TableField("zy_site_qq")
    private Integer zy_site_qq;

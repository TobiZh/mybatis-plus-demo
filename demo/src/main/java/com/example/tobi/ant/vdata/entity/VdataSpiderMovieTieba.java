...
@TableName("vdata.vdata_spider_movie_tieba")
@ApiModel(value = "VdataSpiderMovieTieba对象", description = "")
public class VdataSpiderMovieTieba extends Model<VdataSpiderMovieTieba> {

...
@TableName("vdata.vdata_spider_teleplay_baiduindex")
@ApiModel(value = "VdataSpiderTeleplayBaiduindex对象", description = "")
public class VdataSpiderTeleplayBaiduindex extends Model<VdataSpiderTeleplayBaiduindex> {

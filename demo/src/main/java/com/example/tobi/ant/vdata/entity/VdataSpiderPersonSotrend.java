...
@TableName("vdata.vdata_spider_person_sotrend")
@ApiModel(value = "VdataSpiderPersonSotrend对象", description = "")
public class VdataSpiderPersonSotrend extends Model<VdataSpiderPersonSotrend> {
    ...
    @TableField("person_sotrend")
    private Integer person_sotrend;

...
@TableName("vdata.vdata_spider_teleplay_site")
@ApiModel(value = "VdataSpiderTeleplaySite对象", description = "")
public class VdataSpiderTeleplaySite extends Model<VdataSpiderTeleplaySite> {

...
@TableName("vdata.vdata_spider_movie_weibo")
@ApiModel(value = "VdataSpiderMovieWeibo对象", description = "")
public class VdataSpiderMovieWeibo extends Model<VdataSpiderMovieWeibo> {

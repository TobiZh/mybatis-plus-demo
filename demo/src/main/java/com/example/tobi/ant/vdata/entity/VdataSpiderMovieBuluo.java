...
@TableName("vdata.vdata_spider_movie_buluo")
@ApiModel(value = "VdataSpiderMovieBuluo对象", description = "")
public class VdataSpiderMovieBuluo extends Model<VdataSpiderMovieBuluo> {

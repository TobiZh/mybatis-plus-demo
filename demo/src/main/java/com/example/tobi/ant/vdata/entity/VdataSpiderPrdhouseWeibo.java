...
@TableName("vdata.vdata_spider_prdhouse_weibo")
@ApiModel(value = "VdataSpiderPrdhouseWeibo对象", description = "")
public class VdataSpiderPrdhouseWeibo extends Model<VdataSpiderPrdhouseWeibo> {

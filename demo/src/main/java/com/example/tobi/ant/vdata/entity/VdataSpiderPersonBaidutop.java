...
@TableName("vdata.vdata_spider_person_baidutop")
@ApiModel(value = "VdataSpiderPersonBaidutop对象", description = "")
public class VdataSpiderPersonBaidutop extends Model<VdataSpiderPersonBaidutop> {
    ...
    @TableField("person_baidutop")
    private Integer person_baidutop;

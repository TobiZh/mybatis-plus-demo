...
@TableName("vdata.vdata_spider_movie_site")
@ApiModel(value = "VdataSpiderMovieSite对象", description = "")
public class VdataSpiderMovieSite extends Model<VdataSpiderMovieSite> {
    ...
    @TableField("movie_site")
    private Integer movie_site;

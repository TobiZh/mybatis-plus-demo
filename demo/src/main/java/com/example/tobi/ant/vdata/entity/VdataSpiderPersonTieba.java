...
@TableName("vdata.vdata_spider_person_tieba")
@ApiModel(value = "VdataSpiderPersonTieba对象", description = "")
public class VdataSpiderPersonTieba extends Model<VdataSpiderPersonTieba> {

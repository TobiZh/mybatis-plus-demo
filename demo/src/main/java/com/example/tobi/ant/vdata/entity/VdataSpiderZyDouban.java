...
@TableName("vdata.vdata_spider_zy_douban")
@ApiModel(value = "VdataSpiderZyDouban对象", description = "")
public class VdataSpiderZyDouban extends Model<VdataSpiderZyDouban> {

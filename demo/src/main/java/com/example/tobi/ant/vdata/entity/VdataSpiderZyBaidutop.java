...
@TableName("vdata.vdata_spider_zy_baidutop")
@ApiModel(value = "VdataSpiderZyBaidutop对象", description = "")
public class VdataSpiderZyBaidutop extends Model<VdataSpiderZyBaidutop> {
    ...
    @TableField("zy_baidutop")
    private Integer zy_baidutop;

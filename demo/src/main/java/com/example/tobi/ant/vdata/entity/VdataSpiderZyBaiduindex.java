...
@TableName("vdata.vdata_spider_zy_baiduindex")
@ApiModel(value = "VdataSpiderZyBaiduindex对象", description = "")
public class VdataSpiderZyBaiduindex extends Model<VdataSpiderZyBaiduindex> {
